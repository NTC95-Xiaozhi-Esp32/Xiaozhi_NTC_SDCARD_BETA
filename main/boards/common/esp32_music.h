...
private:
    ...
    std::atomic<bool>        auto_cache_to_sd_;     // bật/tắt auto cache (mặc định bật)
    std::atomic<bool>        is_caching_;           // trạng thái thread cache MP3
    ...
    size_t   final_pcm_data_fft_size = 0;    // kích thước buffer FFT
